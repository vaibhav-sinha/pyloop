...
from v5.syscall import WaitForRead, WaitForWrite, NewTask
...
class HttpServer:
    ...
    def handle_client(self, client):
        ...
        response = handler(HttpRequest(path))
    ...
    def _404_handler(request):
        return HttpResponse(HttpStatus.NOT_FOUND, {}, f"<html><body>Could not find URL {request.path}</body></html>")
